...
const skills = [
  ...
  { name: "Next.js", icon: null, color: "#000000", level: 75 }, // Set icon to null for Next.js
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {skills.map((skill, index) => (
            <div
              key={index}
              className="bg-white rounded-lg p-6 shadow-lg transition-transform duration-300 hover:scale-105 border border-gray-200"
            >
              <div className="flex items-center mb-4">
                {skill.icon ? (
                  ...
                  <svg
                    ...
                    className="text-4xl mr-4"
                    style={{ fill: skill.color, width: '1em', height: '1em' }}
                  >
              ...
              <div className="relative pt-1">
                <div className="flex mb-2 items-center justify-between">
                  <div>
                    <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-primary bg-gray-200">
                      {skill.level}%
                    </span>
                  </div>
                </div>
